...
import android.alex.com.pushandtalk.LetterView;
import android.alex.com.pushandtalk.R;
import android.alex.com.pushandtalk.adapter.MembersAdapter;
import android.alex.com.pushandtalk.event.MemberLetterEvent;
...
public class AVSquareMembersActivity extends AVBaseActivity {
  ...
  protected Toolbar toolbar=(Toolbar)findViewById(R.id.toolbar);
  protected SwipeRefreshLayout refreshLayout=(SwipeRefreshLayout)findViewById(R.id.activity_square_members_srl_list);
  protected LetterView letterView=(LetterView)findViewById(R.id.activity_square_members_letterview);
  protected RecyclerView recyclerView=(RecyclerView)findViewById(R.id.activity_square_members_rv_list);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    toolbar.setNavigationIcon(R.mipmap.btn_navigation_back);
